...
of `1.0.13`. It is not a release checklist. The active GitHub milestone and
...
The `1.0.13` milestone concentrates on hardening behavior that now spans several
...
See the [open `1.0.13` issues](https://github.com/AI3I/pyCluster/issues?q=is%3Aissue%20is%3Aopen%20milestone%3A1.0.13)
